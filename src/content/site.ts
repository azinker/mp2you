...
const he: SiteContent = {
  ...
  settings: {
    siteName: "MorePower2You",
    tagline: "הכוח של מתנה מדויקת בתוכניות ארגוניות מודרניות.",
    contactNote: "פניות לפרויקטים מתקבלות דרך טופס מאובטח.",
    serviceArea: "תמיכה בפרויקטי מתנות, קונסיירז', אחסון, לוגיסטיקה ומשלוחים בארץ ובעולם.",
    legacyPrivateAddressNote:
  ...
  footer: {
    description:
      "MorePower2You מתכננת, מאתרת, ממותגת, אורזת, מאחסנת ושולחת פרויקטי מתנות וקונסיירז' לחברות שרוצות שכל פרט יטופל ברמה גבוהה.",
    columns: [
      {
        title: "החברה",
        links: [
  ...
  home: {
    ...
    seo: {
      ...
      description:
        "שירות פרימיום למתנות ארגוניות, קופסאות ממותגות, קונסיירז', אחסון, שילוח ומתנות VIP לחברות בכל היקף.",
      keywords: ["מתנות ארגוניות", "קופסאות מתנה ממותגות", "מתנות VIP", "מתנות לגיימינג"],
    },
    hero: {
      eyebrow: "מתנות, קונסיירז' ולוגיסטיקה מקצה לקצה",
      title: "מתנות ארגוניות מותאמות, מהרעיון ועד היעד.",
      text:
        "MorePower2You יוצרת תוכניות מתנות פרימיום, קופסאות ממותגות, מתנות VIP, קמפיינים עונתיים ופרויקטי קונסיירז' מורכבים, כולל איתור מוצרים, אריזה, אחסון, שילוח וליווי.",
      proof: ["פרויקטים נבחרים עם 5,000+ מתנות", "תמיכה בארץ ובעולם", "ממארזי אוכל ומתוקים ועד אלקטרוניקה ועוד"],
      primaryCta: { label: "התחילו פרויקט מתנות", href: "/he/contact" },
      secondaryCta: { label: "איך זה עובד", href: "/he/process" },
    },
    proof: [
      { title: "מקצה לקצה", text: "רעיון, איתור מוצרים, התאמה אישית, אריזה, אחסון, שילוח וליווי הפרויקט." },
      { title: "גמישות בהיקף", text: "מתאים לקמפיינים גדולים וגם לפרויקטים קטנים ומדויקים כשזה נכון." },
      { title: "תחושת פרימיום", text: "שותף לצוותי שיווק, HR, תפעול, הנהלה, אירועים ותוכניות VIP שרוצים תוצאה מוקפדת." },
    ],
    whatWeDo: {
      eyebrow: "מה MorePower2You עושה",
      title: "מתנות מיוחדות ושירותי קונסיירז' במקום אחד.",
      text:
        "העבודה מתחילה במטרה של המתנה ומסתיימת בתוכנית מוכנה שאנשים שמחים לקבל. MorePower2You יכולה לבנות קונספט, לאתר מוצרים, לתאם אריזה ממותגת, לנהל אחסון, להרכיב משלוחים ולתמוך בשליחה ליעדים בארץ ובעולם.",
      items: [
        ...
        { title: "קופסאות ממותגות", text: "אריזה, כרטיסי מסר, תמהיל מוצרים, התאמה אישית וחוויית פתיחה." },
        { title: "הרכבה ומשלוחים מרוכזים", text: "אחסון, הרכבת ערכות, ניהול כתובות ותמיכה בשילוח." },
      ],
    },
    process: [
      { title: "אפיון", text: "מגדירים קהל, אירוע, היקף, יעדים, לוחות זמנים וצרכי מיתוג." },
      { title: "בחירה ואיתור", text: "בונים אפשרויות למוצרים ולאריזה שמתאימות למותג ולרגע." },
      { title: "התאמה אישית", text: "מתאמים פריטים ממותגים, כרטיסי מסר, אריזות ופרטים אישיים." },
      { title: "אריזה", text: "מרכיבים קופסאות, ערכות ויחידות מוכנות לשליחה." },
      { title: "אחסון והרכבה", text: "תמיכה באחסון, מלאי, משלוחים מרוכזים ומשלוחים חוזרים." },
      { title: "שילוח", text: "הכנת פרויקטים למשלוח בארץ או בעולם עם טיפול מסודר ביעדים." },
      { title: "ליווי", text: "תיאום קונסיירז' צמוד ששומר על הפרויקט מסודר ומתקדם." },
    ],
    occasions: [
      "מתנות לחגים",
      "מתנות כריסמס",
      "מתנות יום הולדת",
      "מתנות איסטר ועונות חג",
      "הוקרת לקוחות",
    ...
    finalCta: {
      ...
      items: [
        { title: "קריאה ראשית", text: "התחילו פרויקט מתנות" },
        { title: "קריאה משנית", text: "לשירותים" },
      ],
    },
  },
  pages: [
    {
      ...
      intro:
        "MorePower2You היא שותפה למתנות מיוחדות, קונסיירז' ולוגיסטיקה עבור חברות שרוצות חוויית מתנה מוקפדת בלי לנהל כל פרט לבד.",
      primaryCta: { label: "התחילו פרויקט", href: "/he/contact" },
      secondaryCta: { label: "לשירותים", href: "/he/services" },
      ...
      blocks: [
        {
          ...
          text:
            "MorePower2You מחברת בין מתנות מיוחדות לשירותי קונסיירז' כדי לקחת פרויקט מהרעיון ועד הביצוע. האתר החדש מתמקד במתנות ארגוניות, קופסאות ממותגות, לקוחות VIP, אחסון, הרכבה ושילוח.",
          items: [
            ...
            { title: "עבודה בארץ ובעולם", text: "האתר מדבר על אזורי שירות ואינו מציג כתובת פיזית ציבורית." },
          ],
        },
      ],
    },
    {
      ...
      intro: "MorePower2You מחברת בין הרעיון הקריאייטיבי לבין הביצוע התפעולי, מרעיון ראשוני ועד תוכנית מוכנה.",
      primaryCta: { label: "התחילו פרויקט מתנות", href: "/he/contact" },
      secondaryCta: { label: "ראו את התהליך", href: "/he/process" },
      seo: { title: "שירותי מתנות ארגוניות | קופסאות ממותגות ושילוח", description: "שירותי MorePower2You למתנות ארגוניות, קופסאות ממותגות, קונסיירז', אחסון, הרכבה ושילוח.", keywords: ["שירותי מתנות ארגוניות", "קופסאות ממותגות"] },
      blocks: [{ title: "ארבע דרכים להוריד מכם עומס.", text: "אפשר להשתמש בכל שירות בנפרד או לחבר אותם לפרויקט מנוהל מתחילתו ועד סופו. הדגש הוא מתנות ארגוניות בהיקפים גדולים, לצד פרויקטים קטנים ומדויקים כשזה מתאים." }],
    },
    {
      ...en.pages[2],
      title: "למי זה מתאים",
      eyebrow: "לחברות שרוצות שמתנה תרגיש מדויקת",
      intro: "כרגע מתפרסם עמוד ייעודי לגיימינג ומתנות VIP, ובהמשך ניתן להוסיף עמודים לתחומים נוספים.",
      primaryCta: { label: "התחילו פרויקט", href: "/he/contact" },
      secondaryCta: { label: "גיימינג ומתנות VIP", href: "/he/gaming-vip-player-gifting" },
      seo: { title: "מתנות ארגוניות לגיימינג, טק, פיננסים ועוד", description: "MorePower2You תומכת במתנות לחברות גיימינג, טכנולוגיה, נדל\"ן, פיננסים, אירוח, בריאות ואירועים.", keywords: ["מתנות לפי תחום", "מתנות לגיימינג"] },
      blocks: [{ title: "שותף גמיש לצוותים שונים.", text: "בין אם הקהל הוא שחקני VIP, לקוחות מכירות, עובדים באזורים שונים, לקוחות הנהלה או משתתפי אירועים, הפרויקט נבנה סביב הקהל, האירוע והמורכבות." }],
    },
    {
      ...en.pages[3],
      title: "תהליך",
      eyebrow: "איך זה עובד",
      intro: "פרויקט מתנות טוב צריך גם טעם וגם ביצוע. MorePower2You שומרת על תהליך ברור מאפיון ועד שילוח.",
      primaryCta: { label: "התחילו פרויקט מתנות", href: "/he/contact" },
      secondaryCta: { label: "לשירותים", href: "/he/services" },
      seo: { title: "איך עובד פרויקט מתנות ארגוניות | MorePower2You", description: "תהליך הכולל אפיון, איתור מוצרים, התאמה אישית, אריזה, אחסון, הרכבה, שילוח וליווי.", keywords: ["תהליך מתנות ארגוניות"] },
      blocks: [{ title: "תהליך ברור לעבודה מותאמת.", text: "כל פרויקט מתוכנן ומתומחר לפי היקף. התהליך מסודר מספיק לתוכניות גדולות וגמיש מספיק כדי לפתור בקשות מיוחדות בסגנון קונסיירז'." }],
    },
    {
      ...en.pages[4],
      title: "גלריה",
      eyebrow: "השראה חזותית למתנות",
      intro: "הגלריה מציגה כיוון לקופסאות מתנה, אריזה ולוגיסטיקה בשפה נקייה ופרימיום.",
      seo: { title: "גלריית מתנות | MorePower2You", description: "גלריית השראה למתנות, קופסאות ממותגות, אריזה ולוגיסטיקה.", keywords: ["גלריית מתנות", "קופסאות מתנה"] },
      blocks: [{ title: "התמונות זמניות עד להחלפה בתמונות פרימיום.", text: "הכיוון החזותי: רקעים ניטרליים וחמים, אריזות איכותיות, בלי לוגואים מזויפים ובלי מראה של סלסלות מתנה זולות." }],
    },
    {
      ...en.pages[5],
      title: "פרופילי פרויקטים",
      eyebrow: "פרופילים אנונימיים וסוגי פרויקטים לדוגמה",
      intro: "הפרופילים מוצגים כתרחישי תכנון לדוגמה, בלי לחשוף או להמציא שמות לקוחות.",
      seo: { title: "פרופילי מתנות ארגוניות | MorePower2You", description: "פרופילים לדוגמה למתנות VIP, חגים, אחסון, הרכבה וערכות השקה.", keywords: ["פרופילי מתנות", "דוגמאות מתנות VIP"] },
      blocks: [{ title: "השתמשו בפרופילים כדי לפתוח שיחה ממוקדת יותר.", text: "כל פרופיל מציג אתגר, גישה ותוצאה אפשרית, בלי שמות לקוחות ובלי נתונים לא מבוססים." }],
    },
    {
      ...en.pages[6],
      title: "המלצות",
      eyebrow: "מה לקוחות מעריכים",
      intro: "המלצות שמדגישות תיאום מסודר, רעיונות טובים וביצוע אמין.",
      seo: { title: "המלצות לקוחות | MorePower2You", description: "המלצות על אחסון, הרכבה, רעיונות למתנות ותיאום פרויקטים.", keywords: ["המלצות MorePower2You"] },
    },
    {
      ...en.pages[7],
      title: "שאלות נפוצות",
      eyebrow: "תשובות לפני שמתחילים",
      intro: "תשובות לחברות שמתכננות מתנות ארגוניות, קופסאות ממותגות, מתנות VIP, אחסון ומשלוחים.",
    ...
    },
    {
      ...en.pages[8],
      title: "פנייה לפרויקט",
      eyebrow: "התחילו פרויקט מתנות",
      intro: "ספרו ל-MorePower2You מה אתם מתכננים. הטופס שואל על היקף, לוחות זמנים, יעדים וצרכי התאמה, בלי לבקש תקציב גלוי.",
      ...
      blocks: [{ title: "מה קורה אחרי השליחה", text: "נבדוק את פרטי הפרויקט ונחזור עם הצעדים הבאים.", items: [{ title: "אין חנות אונליין", text: "כל פרויקט נבחן ומתומחר לפי הצרכים שלו." }, { title: "הטופס הוא הערוץ המרכזי", text: "כך אפשר לקבל את כל הפרטים החשובים בצורה מסודרת." }, { title: "קבצים בהמשך", text: "אם צריך חומרים, לוגואים או רשימות, נתאם זאת לאחר הפנייה." }] }],
    },
    {
      ...en.pages[9],
      title: "הודעת נתונים וטפסים",
      eyebrow: "מידע קצר על נתונים",
      intro: "האתר משתמש בטופס פנייה לפרויקט, מערכת ניהול תוכן, שליחת אימיילים והגנת ספאם. האתר אינו כולל סקריפטים נפרדים לאנליטיקה.",
      ...
      blocks: [{ title: "נתוני טופס ושירותים", text: "טופס הפנייה אוסף את פרטי הקשר והפרויקט שהמבקר שולח. האתר משתמש גם ב-Sanity לניהול תוכן, Resend לשליחת אימיילים, Cloudflare Turnstile להגנת ספאם ו-Vercel לאחסון." }],
    },
  ],
  services: en.services.map((service) => {
    ...
    const isGaming = service.slug === "gaming-vip-player-gifting";
    const summary = isGaming
    ...
    const intro = isGaming
      ? "למותגי גיימינג יש קהלים מעורבים במיוחד. MorePower2You עוזרת להפוך נאמנות, אבני דרך ועונות למתנות מוחשיות שמרגישות פרימיום ונכונות למותג."
      : "MorePower2You עוזרת לתכנן ולבצע פרויקט מתנות מדויק, מוקפד ומסודר תפעולית.";
    const blockTitle = isGaming ? "מתנות לשחקני VIP, לקוחות מובילים וקהילות נאמנות." : "אסטרטגיה, מוצרים, אריזה וביצוע במקום אחד.";
    const blockText = isGaming
      ? "התוכניות יכולות לתמוך באפליקציות קזינו, RPG, משחקי פעולה והרפתקה, משחקי אסטרטגיה, שחקני VIP, תוכניות נאמנות, אבני דרך, מהלכים עונתיים וקמפיינים להוקרה."
      : "הפרויקט מתוכנן סביב קהל, אירוע, היקף, צרכי מיתוג, אחסון, יעדים ולוח זמנים.";

    return {
      ...service,
      title,
      eyebrow: isGaming ? "עמוד ייעודי לתחום" : "שירות מרכזי",
      summary,
      intro,
      primaryCta: { label: "התחילו פרויקט", href: "/he/contact" },
      secondaryCta: { label: "ראו את התהליך", href: "/he/process" },
      seo: {
        title: `${title} | MorePower2You`,
        description: summary,
      ...
      blocks: [
        {
          ...
          items: [
            ...
            { title: "התאמה להיקף", text: "מתאים מפרויקטים קטנים ועד קמפיינים גדולים, כולל פרויקטים נבחרים עם 5,000+ מתנות." },
            { title: "התאמה למותג", text: "מוצרים, אריזה, כרטיסי מסר ותוכן שמרגישים חלק מהמותג." },
          ],
        },
      ],
    };
  ...
  industries: [
    { title: "חברות גיימינג ואפליקציות קזינו", text: "מתנות לשחקני VIP, אבני דרך, נאמנות, מהלכים עונתיים והוקרת לקוחות מובילים." },
    { title: "חברות טכנולוגיה", text: "מתנות ללקוחות, עובדים, השקות, אונבורדינג ואירועים." },
    { title: "חברות נדל\"ן", text: "מתנות סגירה, הוקרת מפנים, קמפיינים ליזמים ומתנות VIP." },
    ...
    { title: "חברות אירועים", text: "ערכות השקה, מתנות למשתתפים, קופסאות ספונסרים ומשלוחים אחרי אירוע." },
    { title: "שיווק, HR ותפעול", text: "שותף פרקטי לצוותים שרוצים שהמתנות יטופלו בטעם ובסדר." },
  ],
  testimonials: [
    { name: "Dani L.", context: "אחסון ומשלוחים חוזרים", quote: "היינו צריכים לאחסן מוצרים ולשלוח אותם מדי חודש. MorePower2You הפכה את התהליך לפשוט, עם אחסון בטוח וביצוע אמין בכל פעם." },
    { name: "Tyler M.", context: "תיאום פרויקט מורכב", quote: "MorePower2You ניהלה פרויקט מורכב משלב התיאום ועד האישור הסופי. הסבלנות, הדיוק וההבנה של הצרכים שלנו גרמו לפרויקט לרוץ חלק, ואנחנו ממשיכים לעבוד איתם." },
    { name: "Brandi E.", context: "מתנות ללקוחות", quote: "המתנות ללקוחות שלנו היו מעולות. הם הביאו רעיונות חכמים, עזרו לנו להגיע בדיוק למה שרצינו, הציגו הכול בצורה מקצועית ושלחו בזמן." },
    { name: "Charlene R.", context: "רעיונות לקהל מגוון", quote: "היינו צריכים רעיונות לקבוצת לקוחות גדולה ומגוונת. MorePower2You הביאה אפשרויות יצירתיות ומחושבות, והצוות שלנו הרגיש את ההשקעה בכל המלצה." },
  ],
  faqs: [
    { question: "אילו פרויקטי מתנות אפשר לבצע?", answer: "קמפיינים ארגוניים, קופסאות ממותגות, מתנות VIP, הוקרת עובדים, מתנות עונתיות, ערכות אירוע, השקות, אבני דרך, אחסון, הרכבה, שילוח ופרויקטי קונסיירז'." },
    { question: "האם אפשר לטפל בהיקפים גדולים?", answer: "כן. האתר מדגיש מתנות ארגוניות בהיקף גדול, וניתן לציין שפרויקטים נבחרים כללו 5,000+ מתנות. גם פרויקטים קטנים יותר אפשריים כשזה מתאים." },
    { question: "האם יש מחירים קבועים?", answer: "לא. כל פרויקט מתומחר לפי מספר המקבלים, תמהיל המוצרים, התאמה אישית, אריזה, אחסון, שילוח, מספר יעדים ולוח זמנים." },
    { question: "האם ניתן למתג או להתאים מתנות?", answer: "כן. קופסאות, כרטיסי מסר, אריזה ומוצרים נבחרים יכולים להיות ממותגים או מותאמים לפי היקף וזמינות." },
    { question: "האם יש שילוח בארץ ובעולם?", answer: "ניתן לתכנן פרויקטים ומשלוחים ליעדים בארץ ובעולם, בהתאם למוצרים, רשימת היעדים ולוחות הזמנים." },
    { question: "האם הטופס שואל על תקציב?", answer: "לא. הטופס מתמקד בהיקף הפרויקט, בקהל, בלוח הזמנים, בהתאמה האישית ובלוגיסטיקה." },
    { question: "האם אפשר לאחסן מוצרים ולשלוח בהמשך?", answer: "כן. אחסון ותכנון מלאי יכולים להיות חלק מהפרויקט, כולל משלוחים חוזרים או מדורגים." },
    ...
    { question: "האם מוצגים טלפון או כתובת?", answer: "לא. האתר מציג אזורי שירות ומשתמש בטופס הפנייה כערוץ המרכזי." },
  ],
          ...
          : item.title === "Unboxing experience"
            ...
            : item.title === "Branded gift context"
              ...
              : item.title === "Mass mailing support"
                ? "תמיכה במשלוחים מרוכזים"
                : "בחירת מתנות בקונסיירז'",
    text: "תמונה זמנית מהאתר הקיים, עד להחלפה בתמונות פרימיום חדשות.",
  })),
  caseStudies: en.caseStudies.map((item) => ({
    ...
    title:
      item.slug === "vip-player-milestone-drop"
        ? "מתנת אבן דרך לשחקני VIP"
        : item.slug === "holiday-corporate-gifting-program"
          ? "קמפיין מתנות לחגים"
          : item.slug === "recurring-storage-fulfillment"
            ? "אחסון ומשלוחים חוזרים"
            : "ערכת השקה ואירוע ממותגת",
    summary: "תרחיש תכנון אנונימי שמציג צורך, גישה ותוצאה אפשרית בלי לציין לקוח בשם.",
    challenge: "הצוות צריך מתנה שמרגישה מדויקת ומאורגנת בלי לנהל את כל הפרטים לבד.",
    approach: "MorePower2You יכולה לסייע בבחירת מוצרים, אריזה, כרטיסי מסר, אחסון, הרכבה ושילוח לפי הצורך.",
    outcome: "חוויית מתנה מוקפדת שתומכת בהוקרה, נאמנות וזכירות.",
  })),
          ...
          : post.slug === "holiday-gifting-timeline"
            ...
            : post.slug === "premium-custom-branded-gift-boxes"
              ...
              : post.slug === "gift-fulfillment-logistics-questions"
                ? "שאלות לוגיסטיקה לפני מהלך מתנות גדול"
                : post.title;
    const excerpt = post.status === "published" ? "מאמר קצר ושימושי לתכנון פרויקט מתנות מדויק ואמין." : "טיוטת תוכן לפיתוח עתידי.";

    return {
      ...post,
      title,
      excerpt,
      seo: { ...post.seo, title, description: excerpt },
      sections:
        post.status === "published"
          ? [
              { title: "להתחיל מהקהל", text: "ההחלטות החשובות ביותר הן מי מקבל, כמה מקבלים, לאן שולחים ומה הרגע שהמתנה אמורה לחזק." },
              { title: "לחבר קריאייטיב ותפעול", text: "מוצר יפה לא מספיק בלי אריזה, כתובות יעד, אחסון, לוח זמנים והרכבה מסודרת." },
              { title: "להשאיר מקום להתאמה", text: "פרויקטים טובים מאפשרים מיתוג, שכבות VIP והבדלים בין קבוצות בלי לאבד עקביות." },
            ]
          : [{ title: "הערת טיוטה", text: "טיוטת תוכן לפיתוח עתידי." }],
    };
  }),
  resources: en.resources.map((resource) => ({
    ...
    summary: "מדריך פתוח לתכנון פרויקט מתנות. בהמשך אפשר להפוך אותו ל-PDF.",
    sections: [
      { title: "קהל", text: "הגדירו קבוצות מקבלים, היקף, שכבות VIP, קשר למותג וצרכי התאמה אישית." },
      { title: "אירוע", text: "האם זו מתנת חג, הוקרת לקוחות, VIP, עובדים, אירוע, השקה או אבן דרך." },
      { title: "תפעול", text: "רכזו יעדים, רשימות, אחסון, התאמה אישית, אריזה ולוח זמנים." },
    ],
  })),
  legal: [
    {
      ...
      eyebrow: "פרטיות",
      intro: "זוהי מדיניות פרטיות ראשונית לקראת השקה, ויש להעביר אותה לבדיקה משפטית לפני פרסום.",
      ...
      blocks: [
        ...
        { title: "שימוש במידע", text: "המידע משמש לבדיקת בקשות, חזרה עם הצעדים הבאים וניהול פנימי של הפנייה." },
        { title: "שירותים חיצוניים", text: "האתר משתמש או מוכן לשימוש ב-Sanity, Resend, Cloudflare Turnstile ו-Vercel." },
      ],
    },
    {
      ...en.legal[1],
      title: "תנאים והגבלות",
      eyebrow: "תנאים",
      intro: "אלו תנאים ראשוניים למידע בלבד, ויש להעביר אותם לבדיקה משפטית לפני פרסום.",
      seo: { title: "תנאים והגבלות | MorePower2You", description: "תנאים והגבלות עבור MorePower2You.", keywords: ["תנאים"] },
      blocks: [
        { title: "היקף פרויקט מותאם", text: "כל פרויקט מתנות וקונסיירז' מוגדר לפי היקף. הצעה, לוח זמנים, זמינות מוצרים ותמחור יאושרו בכתב." },
        { title: "אין חנות אונליין", text: "האתר אינו מוכר מוצרים לרכישה ישירה, אלא אוסף פניות לפרויקטים מותאמים." },
